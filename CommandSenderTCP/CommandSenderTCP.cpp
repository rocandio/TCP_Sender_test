...
#define MDC_PORT 1515
#define TV_IP_TEST  "192.168.100.83"
#define CMD_CLOSE_CONNECTION 2
...
int __cdecl main(int argc, char** argv)
{
	...
	InetPton(AF_INET,TV_IP_TEST, &addrServer.sin_addr.s_addr);
	//InetPton(AF_INET, "192.168.0.20", &addrServer.sin_addr.s_addr);
	addrServer.sin_port = htons(MDC_PORT);
	memset(&(addrServer.sin_zero), '\0', 8);

	// Connect to LFD Decvice(s).
